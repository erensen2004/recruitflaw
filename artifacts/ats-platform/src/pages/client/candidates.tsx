    ...
    <DashboardLayout allowedRoles={["client"]}>
      ...
      <div className="mb-4 flex flex-col gap-2 xl:flex-row xl:items-center">
        <div className="relative xl:min-w-[280px] xl:flex-[1.3]">
            ...
            placeholder="Search by candidate, email, role, or vendor..."
        ...
        {isLoading ? (
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-50 border-b border-slate-100">
              <tr>
        {["Candidate", "Role", "Company", "Status", "CV", ""].map(h => (
                  ...
                  <tr key={c.id} className="transition-colors hover:bg-slate-50/50">
                    ...
                    <td className="px-5 py-3.5">
                      {c.cvUrl ? (
                        <PrivateObjectLink
                          objectPath={c.cvUrl}
                          className="inline-flex items-center gap-1 text-xs font-medium text-slate-700 transition hover:text-primary">
                    ...
                    <td className="px-5 py-3.5">
                      <Link
                        ...
                        className="inline-flex min-h-8 items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 text-xs font-medium text-slate-700 transition hover:border-primary hover:text-primary"
                      >
